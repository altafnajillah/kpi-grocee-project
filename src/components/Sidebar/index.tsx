    ...
    menuItems: [
      ...
      },
      {
        ...
        children: [
          {
            label: "Pendaftaran",
            route: "/admin/barang/pendaftaran",
          },
          { label: "Peminjaman", route: "/admin/barang/peminjaman" },
          {
            label: "Riwayat",
            route: "/admin/barang/riwayat",
          },
        ],
      },
      {
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-red-700 duration-300 ease-linear dark:bg-red-900 lg:translate-x-0 ${
