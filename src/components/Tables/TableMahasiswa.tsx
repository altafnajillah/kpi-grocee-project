import { Mahasiswas } from "@/types/mahasiswa";

const packageData: Mahasiswas[] = [
  {
    id: "1",
          ...
          <tbody>
            {packageData.map((mahasiswa, key) => (
              <tr key={key} className="text-left">
                ...
                <td className="border-b border-[#eee] px-4 py-5 pl-4">
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  ...
                  >
                    {!mahasiswa.jk ? "Laki-laki" : "Perempuan"}
                  </p>
                </td>
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
