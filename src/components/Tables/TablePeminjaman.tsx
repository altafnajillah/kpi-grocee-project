                ...
                {peminjamanData.map((data, key) => (
                    ...
                    >
                        <div className="flex p-2.5 xl:p-5">
                            ...
                            <p className="flex text-black dark:text-white sm:block">
                                {data.tglpinjam}
                            </p>
                        </div>
                        ...
                        <div className="flex p-2.5 xl:p-5">
                            <p className="text-black dark:text-white">{data.barang}</p>
                        </div>
                        ...
                        <div className="flex p-2.5 sm:flex xl:p-5">
                            ...
                            <Link href={"#"} className={"bg-danger p-2 rounded-sm text-white"}>
                                <svg
                            ...
                            <Link href={"#"} className={"bg-primary p-2 rounded-sm text-white ml-1"}>
                                <svg
                                    className="fill-current"
                                    width="20"
                                    height="20"
