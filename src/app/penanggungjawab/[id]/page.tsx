    ...
    <DefaultLayout>
      <div className="mx-auto w-full max-w-lg flex-1 rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        <div className="mb-6 flex justify-between">
          ...
          <Link href='/penanggungjawab' className="p-1 rounded-sm border">
            <IoClose size={20}/>
          </Link>
        </div>
          ...
          <div className="p-2.5 xl:p-5">
            ...
            <div className="flex justify-between">
              <div>
                ...
                <Link href={`/penanggungjawab/edit/${data.id}`} className="ml-1 rounded-sm bg-warning p-2 text-white">
                  {/* <IoDocumentText size={20}/> */}Edit
                </Link>
              </div>
              <button type='submit' className="ml-1 rounded-sm bg-danger p-2 text-white">
